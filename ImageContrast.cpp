...
ImgCon::ImgCon()
{
	h_w_bin0 = new bool **[1000];
	for (int i = 0; i < 1000; i++)
	{
		h_w_bin0[i] = new bool *[1000];
	...
	h_w_bin1 = new bool **[1000];
	for (int i = 0; i < 1000; i++)
	{
		h_w_bin1[i] = new bool *[1000];
		for (int j = 0; j < 1000; j++)
		{
	...
	haar_val0 = new int **[1000];
	for (int i = 0; i < 1000; i++)
	{
		haar_val0[i] = new int *[1000];
		for (int j = 0; j < 1000; j++)
		{
	...
	haar_val1 = new int **[1000];
	for (int i = 0; i < 1000; i++)
	{
		haar_val1[i] = new int *[1000];
		for (int j = 0; j < 1000; j++)
		{
	...
	intgrlimg0 = new int *[1000];
	for (int i = 0; i < 1000; i++)
	{
		intgrlimg0[i] = new int[1000];
	}

	intgrlimg1 = new int *[1000];
	for (int i = 0; i < 1000; i++)
	{
		intgrlimg1[i] = new int[1000];
	}

	damagelevel = new int *[1000];
	for (int i = 0; i < 1000; i++)
	{
		damagelevel[i] = new int[1000];
	}
}
ImgCon::~ImgCon()
{
...
cv::Mat ImgCon::compare(int threshold, bool haar, int flag)
{
	int u, v;
	...
	if (haar)
	{
		for (int i = 2; i < h - 2; i++)
		{
			for (int j = 2; j < w - 2; j++)
			{
				...
				if (flag == 0)
					damagelevel[i][j] = (int)(rad*(12 - count));
				count = 0;
			}
		}
	}
